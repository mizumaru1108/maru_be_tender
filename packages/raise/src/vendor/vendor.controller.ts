  ...
  async getChartData(){
    ...
    [
      {
        name: 'Monthly',
        value: '4,900.50 SAR',
        data: [{ name: 'Monthly', data: [10, 41, 35, 51, 49, 62, 69, 91, 148] }],
        categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep'],
      },
      {
        name: "Daily (last 7 days)",
        value: '1,900.50 SAR', //sum amount of last 7 days
        chartData: [{ name: 'Income1', data: [10, 41, 35, 51, 49, 62, 69, 91, 48]},
    ...
    [
      ...
      },
      {
        name: "Daily (last 7 days)",
        value: '2,500.00 SAR',
        chartData: [{ name: 'Campaign1', data: [10, 41, 35, 51, 49, 62, 69, 91, 48] },
