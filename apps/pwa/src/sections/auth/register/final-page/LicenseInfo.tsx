  ...
  return (
    <Stack direction="column" gap={2}>
      ...
      <Stack direction="column">
        ...
        <Typography sx={{ fontSize: '18px' }}>{data.license_number}</Typography>
      </Stack>
      <Stack direction="row" justifyContent="space-between">
        <Stack direction="column" flex={1}>
          <Typography sx={{ color: '#93A3B0', fontSize: '15px' }}>تاريخ اصدار الترخيص:</Typography>
          <Typography sx={{ fontSize: '20px' }}>{data.license_issue_date.toString()}</Typography>
        </Stack>
        <Stack direction="column" flex={1}>
          <Typography sx={{ color: '#93A3B0', fontSize: '15px' }}>تاريخ انتهاء الترخيص:</Typography>
          <Typography sx={{ fontSize: '18px' }}>{data.license_expired.toString()}</Typography>
        </Stack>
      </Stack>
      <Stack direction="row" justifyContent="space-between">
        <Stack direction="column" flex={1}>
