...
import { GregorianYearTableRow, GregorianYearTableToolbar } from './list';
...
import AddGregorianYearModal from './list/AddGregorianYearModal';
...
export default function GregorianYearTable() {
  const {
    dense,
    page,
    order,
  ...
  return (
    <Container maxWidth={themeStretch ? false : 'lg'}>
      <AddGregorianYearModal open={open} handleClose={handleCloseAddBeneficiare} />
