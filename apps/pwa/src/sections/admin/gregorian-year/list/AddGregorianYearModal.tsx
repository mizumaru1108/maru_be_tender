...
function AddGregorianYearModal({ open, handleClose }: Props) {
  const style = {
      ...
      >
        <Box sx={style}>
          <Stack direction="column" gap={4}>
            <Typography variant="h4">اضافة سنة ميلادية جديدة</Typography>
            <Grid container spacing={2}>
              <Grid item md={6} xs={12}>
                <TextField
                  ...
                  label="التصنيف"
                  placeholder="الرجاء اختيار السنة الميلادية"
                  sx={{ width: '100%' }}
                />
              </Grid>
              <Grid item md={6} xs={12}>
...
export default AddGregorianYearModal;
