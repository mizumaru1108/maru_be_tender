...
import { Avatar, Checkbox, TableRow, TableCell, Typography, Stack, Button } from '@mui/material';
import Label from '../../../../components/Label';
import Iconify from '../../../../components/Iconify';
import { BeneficiariesInterface } from './types';

// ----------------------------------------------------------------------

type Props = {
  row: BeneficiariesInterface;
  selected: boolean;
...
export default function BeneficiariesTableRow({ row, selected, onSelectRow }: Props) {
  const { name } = row;
