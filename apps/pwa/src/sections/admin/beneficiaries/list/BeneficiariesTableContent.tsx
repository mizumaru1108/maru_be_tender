...
import { BeneficiariesTableToolbar, BeneficiariesTableRow } from '.';
//
import { IBeneficiaries } from './types';

// -----------------------------------------------------------------------------------------------

export default function BeneficiariesTableContent({
  data,
  trigger,
}: {
  data: IBeneficiaries[] | [];
  ...
  const [tableData, setTableData] = useState<IBeneficiaries[] | []>(data.map((row) => row));
