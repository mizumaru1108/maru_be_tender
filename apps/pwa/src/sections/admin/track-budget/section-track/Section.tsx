...
function Section({ item, handleDelete, isDeleting }: any) {
      ...
      <Grid item md={12} xs={12}>
        <Stack direction="row" gap={1} justifyContent="space-between">
          <Stack direction="row" flex={1}>
            <IconButton onClick={handleExpnad}>
              {expand ? (
                <svg
                  width="24"
                  height="24"
          ...
          <Stack direction="row" gap={0.7} flex={1} sx={{ alignSelf: 'center' }}>
            ...
            <Typography
              ...
              color="#0E8478"
            >{`${item.budget}.000 ريال`}</Typography>
          </Stack>
          <Stack direction="row" flex={1} gap={2} justifyContent="center">
            <Button
              sx={{
              ...
              startIcon={
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_2224_42114)">
                    <path
            ...
            <LoadingButton
              ...
              startIcon={
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_2224_42108)">
                    <path
              ...
              loading={isDeleting.id === item.id ?? isDeleting.isLoading}
            >
              حذف
            </LoadingButton>
          </Stack>
      ...
      {expand &&
        ...
        item.children.map((item: any, index: any) => (
          <Grid item key={index} md={12} xs={12}>
            <Section item={item} key={index} handleDelete={handleDelete} isDeleting={isDeleting} />
          </Grid>
        ))}
    </Grid>
  );
