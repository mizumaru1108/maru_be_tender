...
import { RegionsTableRow, RegionsTableToolbar } from 'sections/admin/region/list';

// -----------------------------------------------------------------------------------------------

export default function RegionsTableContent({
  data,
  trigger,
}: {
  data: IRegions[] | [];
  ...
  const [tableData, setTableData] = useState<IRegions[] | []>(data.map((row) => row));
