...
const BankingInfoForm = ({ children, onSubmit, initialValue, onDelete, isEdit }: FormProps) => {
  ...
  return (
    <Grid container rowSpacing={4} columnSpacing={7}>
      {tmpBank &&
        tmpBank.length > 0 &&
        tmpBank.map((item: any, index: any) => (
          <>
            <Grid item md={6} xs={12} key={index}>
              ...
              <Stack direction="row" justifyContent="space-around" gap={5} sx={{ mt: '10px' }}>
                <Badge variant={item.is_deleted ? 'dot' : undefined} color="error">
                  <Button
                    disabled={isEdit}
                    sx={{
                    ...
                    startIcon={
                      ...
                      >
                        <g clipPath="url(#clip0_2200_38738)">
                          <path
                ...
                <Button
                  ...
                  startIcon={
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clipPath="url(#clip0_2200_38732)">
                        <path
