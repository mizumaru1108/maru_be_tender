export const ProposalAcceptBySupervisor = `mutation ProposalAcceptBySupervisor($proposal_id: String = "", $new_values: proposal_set_input = {}, $log: [proposal_log_insert_input!] = {}) {
