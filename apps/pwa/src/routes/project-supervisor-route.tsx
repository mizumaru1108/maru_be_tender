...
const PendingCloseReports = Loadable(
  lazy(() => import('pages/project-supervisor/InProcessCloseReports'))
);
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'pending-project-report',
          children: [
            { path: '', element: <PendingCloseReports /> },
            {
              path: ':id/:actionType',
              element: <ProjectDetails />,
            },
