...
export const PATH_CLIENT = {
  ...
  incoming_close_reports: path(ROOTS_CLIENT, '/dashboard/incoming-close-reports'),
...
export const PATH_PROJECT_SUPERVISOR = {
  ...
  incoming_close_reports: path(ROOTS_PROJECT_SUPERVISOR, '/dashboard/incoming-close-reports'),
