...
const ROOTS_PORTAL_REPORT = '/portal-report';
...
export const PATH_FINANCE = {
  ...
  requests_in_process_with_vat: path(ROOTS_FINANCE, '/dashboard/requests-in-process-with-vat'),
...
export const PATH_PROJECT_SUPERVISOR = {
  ...
  pending_close_reports: path(ROOTS_PROJECT_SUPERVISOR, '/dashboard/pending-project-report'),
...
export const PATH_PORTAL_REPORT = {
  root: ROOTS_PORTAL_REPORT,
  app: path(ROOTS_PORTAL_REPORT, '/dashboard/app'),
};
