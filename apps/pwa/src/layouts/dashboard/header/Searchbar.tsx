...
/**
 * Hendy's note: This is the Minimal UI Kit default Searchbar that comes with Minimal UI Kit v3.5.0.
 * Reyhan previously customized v3.2.0's Searchbar and you can consider/merge it here:
 * apps/pwa/src/layouts/dashboard/header/SearchbarV3_2_0.tsx
 * @returns
 */
function Searchbar() {
