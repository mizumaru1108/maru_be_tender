...
import { FEATURE_LOGIN_BY_LICENSE, FEATURE_LOGIN_BY_PHONE, FEATURE_SIGNUP } from '../../config';
      ...
      <RootStyle>
        ...
        <Container maxWidth="sm">
          <ContentStyle>
            ...
            {FEATURE_LOGIN_BY_LICENSE || FEATURE_LOGIN_BY_PHONE ? <NewLoginForm /> : <LoginForm />}
