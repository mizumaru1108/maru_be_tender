...
export const FEATURE_LOGIN_BY_PHONE: boolean =
  process.env.REACT_APP_CONFIG_FEATURE_LOGIN_BY_PHONE &&
...
export const FEATURE_PROPOSAL_MULTIPLE_REGION_ENTITY_AREA: boolean =
  process.env.REACT_APP_CONFIG_FEATURE_PROPOSAL_MULTIPLE_REGION_ENTITY_AREA &&
  process.env.REACT_APP_CONFIG_FEATURE_PROPOSAL_MULTIPLE_REGION_ENTITY_AREA === 'true'
    ? true
    : false;
...
export const FEATURE_MENU_ADMIN_APLICATION_ADMISSION: boolean =
  process.env.REACT_APP_CONFIG_FEATURE_MENU_ADMIN_APLICATION_ADMISSION &&
  process.env.REACT_APP_CONFIG_FEATURE_MENU_ADMIN_APLICATION_ADMISSION === 'true'
    ? true
    : false;
