...
const ar = {
  ...
  review: {
    ...
    no: 'لا',
    sar: 'ريال سعودي',
    does_an_agreement: 'هل تفاصيل تقرير ختامية',
    clasification_field: 'حقل التصنيف',
    clause: 'الشروط',
    support_outputs: 'إخراج الدعمات',
    vat_percentage: 'نسبة ضريبة القيمة المضافة',
    support_goal_id: 'معرف تقرير ختامي',
    support_type: 'نوع الدعم',
    number_of_payments_by_supervisor: 'عدد المدفوعات',
    need_picture: 'يحتاج صورة',
    fsupport_by_supervisor: 'دعم من قبل المشرف',
    state: 'الحالة',
    project_track: 'تتبع المشروع',
    accreditation_type_id: 'نوع التأهيل',
    added_value: 'القيمة المضافة',
    been_made_before: 'قد تم إنشاء قبل',
    been_supported_before: 'قد تم تقديم قبل',
    chairman_of_board_of_directors: 'المحامي',
    reasons_to_accept: 'السببات المقبولة',
    remote_or_insite: 'خارج أو بيضاء',
    target_group_age: 'عمر المجموعة',
    target_group_num: 'رقم المجموعة',
    target_group_type: 'نوع المجموعة',
    support_goals: {
