...
const ar = {
  pages: {
    ...
    ceo: {
      ...
      main: ' لوحة القيادة | المدير التنفيذي',
    },
    client: {
      main: 'صفحة الشريك الرئيسية',
      draft_funding_requests: 'مشاريع الدعم المحفوظة كمسودة',
      previous_funding_requests: 'مشاريع الدعم السابقة',
      appointments_with: 'مواعيد مع الشركة',
