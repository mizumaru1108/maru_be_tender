...
const ar = {
  pages: {
    ...
    common: {
      ...
      print_preview: 'طباعة تفاصيل المشروع',
    ...
    finance: {
      ...
      payment_generate: {
        heading: {
          ...
          the_date: 'التاريخ',
          then_exchange: 'إذن الصرف',
          name_of_entity: 'اسم الجهة',
          batch_number: 'رقم الدفعة',
          support_outputs: 'مخرجات الدعم (لصالح)',
          project_deliverables: 'مخرجات المشروع (نتائج المشروع)',
          does_an_agreement: 'هل هناك اتفاق',
          yes: 'نعم',
          no: 'لا',
        },
      },
      ...
      project_details: {
        payment: {
          ...
          table: {
            ...
            btn: {
              review_transfer_receipt: 'أمر الدفع',
              ...
              exchange_permit_generate_finance: 'إذن الصرف',
              view_transfer_receipt: 'إيصال التحويل',
            },
          },
        },
      },
  ...
  errors: {
    no_project_path: 'لا يوجد مسار لهذا المشروع ( مشروع من المنصة السابقة )',
    something_wrong: 'هناك خطأ ما',
    role: 'اختر أحد هذه الأدوار',
    notes: 'ملاحظة مطلوبة',
    empty_data: 'لاتوجد بيانات',
    bank_information: {
      un_complete_data: 'يرجى التأكد من معلومات البطاقة البنكية لحفظ  التحديثات',
    },
    login: {
      email: {
  ...
  commons: {
    ...
    chip_ongoing: 'المشروع قيد الإجراء',
    chip_canceled: 'المشروع مرفوض',
    chip_pending_canceled: 'المشروع معلق',
    chip_completed: 'المشروع مكتمل',
    chip_asked_for_amandement: 'تم طلب تعديلات',
    chip_asked_for_amandement_payment: 'طلب تعديل الدفع',
    chip_on_revision: 'المشروع قيد المراجعة',
  ...
  account_manager: {
    ...
    table: {
      ...
      td: {
        ...
        label_canceled_account: 'حساب محذوف',
  ...
  review: {
    ...
    action: {
      ...
      complete_payment: 'تم تأكيد إصدار جميع الدفعات',
      complete: 'تم',
  ...
  project_owner_details: {
    accordion: {
      ...
      administrative_tab: {
        ...
        chairman_mobile: 'جوال الرئيس التنفيذي',
        data_entry_name: 'اسم مدخل البيانات',
  ...
  notification: {
    ...
    message: {
      ...
      image: 'لديك رسالة جديدة مع الصورة',
    ...
    error: {
      ...
      password: {
        validation: {
          ...
          special_char: 'تحتوي على حرف خاص واحد على الأقل',
          number: 'تحتوي على رقم واحد على الأقل',
          match: 'كلمة السر غير متطابقة',
          failed: 'هناك مشكلة في التحقق من صحة كلمة المرور',
        },
      },
    },
  },
  ...
  search_component: {
    ...
    by_entity_mobile: 'جوال الجهة',
    by_license_number: 'رقم الترخيص',
    by_email: 'البريد الإلكتروني غير صحيح',
    ascending: 'تصاعدي',
    descending: 'تنازلي',
  ...
  portal_report: {
    ...
    outter_status: {
      ...
      asked_for_amandement: 'طلب تعديل',
      asked_for_amandement_payment: 'طلب تعديل مدفوع',
      pending_canceled: 'في انتظار الإلغاء',
      label: 'حالة المشروع*',
